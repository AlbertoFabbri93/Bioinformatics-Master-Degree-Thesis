...
# Define the groups
cell_groups <- list(
  "Myeloid" = c("Macrophage", "Mast cell", "Monocyte", "Neutrophil", "Dendritic cell"),
  "Stromal cells" = c("Endothelial", "Fibroblast"),
  "Lymphocites" = c("B cell", "T cell CD4", "T cell CD8", "T cell regulatory", "NK cell", "Plasma", "Plasmablast", "Plasmacytoid dendritic cell")
)
...
breast_cancer_patients_immune_cells@meta.data %>%
  ...
  # Add a grouping variable using the assign_group function
  mutate(Group = sapply(!!sym(ist_cluster_var), assign_group)) %>%
  # Plot the data in a grouped barplot
  ggplot(aes(x = !!sym(ist_cluster_var), y = Percentage, fill = Group)) +
...
create_cluster_summary_per_patient(breast_cancer_patients_tumor_cells, chosen_tumor_cluster)
```
