...
cell_type_colors <- c(
  ...
  # Myeloid cells
  # Family of immune cells comprising monocytes, macrophages, myeloid dendritic cells (mDCs), granulocytes, and mast cells that originate from a common myeloid progenitor in the bone marrow
