...
breast_cancer_patients_split <- SplitObject(breast_cancer_patients_filt_cells, split.by = "Patient.ID")
...
patients_ist_sct[["patients_sct_elbow_plot"]] <- patients_sct_elbow_plot
# Run UMAP
...
```{r}
#| label: insitutype-standard-normalization
#| eval: false
...
# Normalize
breast_cancer_patients_analyze <- NormalizeData(breast_cancer_patients_analyze)
# Scale
breast_cancer_patients_analyze <- ScaleData(breast_cancer_patients_analyze)
...
patients_ist_rna[["patients_rna_elbow_plot"]] <- patients_rna_elbow_plot
# Run UMAP
breast_cancer_patients_analyze <- RunUMAP(
  breast_cancer_patients_analyze,
...
# Save the plots
save_plots(niches_stamps_plots, here(images_dir, glue("Stamps_with_{num_niches}_niches")))
```
...
# Save the plots
save_plots(niches_barplot_list, here(images_dir, stat_niches_dir))
save_plots(niches_patient_data, here(images_dir, stat_niches_dir))
```
