...
insitutype_data <- readRDS(here(objects_dir, "integration_ist_semisup.rds"))
```
...
Idents(breast_cancer_patients_integrated) <- ist_cluster_var
clusters_to_keep <- c("a", "b", "c", "d", "e", "f", "g")
...
create_cluster_summary(breast_cancer_patients_tumor_cells, chosen_tumor_cluster)
get_cluster_info(breast_cancer_patients_tumor_cells, chosen_tumor_cluster)
```
