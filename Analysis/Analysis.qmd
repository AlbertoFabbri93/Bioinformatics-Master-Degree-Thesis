...
# Save the plots
save_plots(cell_types_stamps_plots, here(image_dir, "Integration", "Stamps_with_clusters"))
```
...
# Save the plots
save_plots(niches_stamps_plots, here(image_dir, "Integration", "Stamps_with_niches"))
```
...
# Save the plots
save_plots(niches_barplot_list, here(image_dir, "Integration", "Niches_barplots"))
```
