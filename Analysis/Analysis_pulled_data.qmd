...
for (i in 1:nrow(mat)) {
  # Create a new matrix with the same dimensions and names as mat, but all elements are initialized to 0
  mat2 <- matrix(0, nrow = nrow(mat), ncol = ncol(mat), dimnames = dimnames(mat))
  # Fills the i-th row of mat2 with the corresponding i-th row of mat, all other rows in mat2 remain zero
  mat2[i, ] <- mat[i, ]
