...
fibroblast_cells_chosen_resolution_plot <- DimPlot(
  ...
  label = TRUE) +
  labs(title = "Fibroblast Clusters") &
  NoLegend() &
  NoAxes()
# Print DimPlot chosen resolution
...
fibroblast_cells_clusters_plus_patient_clusters <-
  fibroblast_cells_patient_id_plot + fibroblast_cells_chosen_resolution_plot
fibroblast_cells_plots_to_save[["fibroblast_cells_clusters_plus_patient_clusters"]] <-
  fibroblast_cells_clusters_plus_patient_clusters
...
# Loop over each resolution in the list of marker results
for (res in names(fibroblast_cells_markers_list)) {
  
  # Print the current resolution being analyzed
  print(paste("Processing resolution:", res))
  
  # Heatmaps title
  fibroblast_cells_heatmap_title = paste("Fibroblast cells clusters - Resolution:", res)
  
  # Get marker data for the current resolution
  fibroblast_cells_markers_df <- fibroblast_cells_markers_list[[res]]
  ...
  # Save the heatmap for this resolution in the output list
  fibroblast_key_heatmap <- paste0(res, "_heatmap")
  ...
  fibroblast_cells_clusters <-
    setNames(
      factor(
        as.vector(
          breast_cancer_patients_fibroblast_cells@meta.data[[res]]
        )
      ),
  ...
  # Save the heatmap for this resolution in the output list
  fibroblast_key_complex_heatmap <- paste0(res, "_complex_heatmap")
