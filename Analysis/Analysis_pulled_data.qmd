...
# Save the filtered cells object
save_data(cell_sizes_info, here(images_dir))
```
...
save_data(TMA_info_to_save, here(images_dir, "TMA"))
```
...
cellchat <- readRDS(here(objects_dir, glue("cellchat_{CellChatDB_suffix}.rds")))
```
...
saveRDS(cellchat, here(objects_dir, glue("cellchat_{CellChatDB_suffix}.rds")))
```
