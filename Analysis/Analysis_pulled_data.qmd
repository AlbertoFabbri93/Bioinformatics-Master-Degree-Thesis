...
cellchat_images <- glue("{images_dir}/CellChat")
# Create a palette with only the idents used by cellchat otherwise it throws an error
palette_cellchat <- palette_all_cells_types[names(palette_all_cells_types) %in% levels(cellchat@idents)]
...
png(filename = here(cellchat_images,"cellchat_bubbleplot_interactions.png"), width = 20, height = 15, units = "cm", res = 1000)
