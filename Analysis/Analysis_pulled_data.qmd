...
proteins_feature_plots_sct <- lapply(
  ...
  function(x) x & NoLegend() & NoAxes() & labs(subtitle = "All cells"))
...
# Chosen resolution
chosen_fibroblast_cells_cluster_resolution <- 0.7
# Chosen cluster
...
fibroblast_cells_feature_plots <- lapply(
  ...
  function(x) x & NoLegend() & NoAxes() & labs(subtitle = "Fibroblasts"))
